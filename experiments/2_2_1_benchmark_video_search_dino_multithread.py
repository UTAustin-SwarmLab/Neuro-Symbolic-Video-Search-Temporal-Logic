...
############### Variable
root_path = Path("/opt/Neuro-Symbolic-Video-Frame-Search/store/nsvs_artifact/experiment_2.1_nsvs_ltl/dino")
        ...
        for ltl_spec in ltl_video_dir_set:
            ...
            for benchmark_video_file in benchmark_video_file_list:
                ...
                cv_detection_model = GroundingDino(
                    ...
                    weight_path="/opt/Neuro-Symbolic-Video-Frame-Search/store/nsvs_artifact/weights/groundingdino_swinb_cogcoor.pth",  # config.GROUNDING_DINO.GROUNDING_DINO_CHECKPOINT_PATH,
                    config_path="/opt/Neuro-Symbolic-Video-Frame-Search/store/nsvs_artifact/weights/GroundingDINO_SwinB_cfg.py",  # config.GROUNDING_DINO.GROUNDING_DINO_CONFIG_PATH,
                    device="cuda:0",
                )
                csv_result["cv_model"] = "dino"
                csv_result["cv_model_weight"] = "dino"
