...
data_loc = {
    LLMModels[
        0
    ]: "/opt/Neuro-Symbolic-Video-Frame-Search/store/nsvs_artifact/experiment_2.1_nsvs_ltl/yolo/yologpt-3.5-turbo-instruct_benchmark_search_result_v4.csv",
    LLMModels[
        3
    ]: "/opt/Neuro-Symbolic-Video-Frame-Search/store/nsvs_artifact/_result/benchmark_with_coco_and_imagenet/yolo_benchmark_search_result_20231014_224708.csv",
    LLMModels[
        1
    ]: "/opt/Neuro-Symbolic-Video-Frame-Search/store/nsvs_artifact/experiment_2.1_nsvs_ltl/yolo/yologpt-3.5-turbo-0613_benchmark_search_result_v4.csv",
    LLMModels[
        2
    ]: "/opt/Neuro-Symbolic-Video-Frame-Search/store/nsvs_artifact/experiment_2.1_nsvs_ltl/yolo/yologpt-4-0613_benchmark_search_result_v4.csv",
}
result_dict = {}
...
data_loc_waymo = {
    LLMModels[
        0
    ]: "/opt/Neuro-Symbolic-Video-Frame-Search/store/nsvs_artifact/experiment_2.1_nsvs_ltl/mrcnn/mrcnngpt-3.5-turbo-instruct_benchmark_search_result_vwaymo.csv",
    LLMModels[
        3
    ]: "/opt/Neuro-Symbolic-Video-Frame-Search/store/nsvs_artifact/_result/benchmark_with_waymo/waymo_mrcnn_benchmark_search_result_20231108_234248.csv",
    LLMModels[
        1
    ]: "/opt/Neuro-Symbolic-Video-Frame-Search/store/nsvs_artifact/experiment_2.1_nsvs_ltl/mrcnn/mrcnngpt-3.5-turbo-0613_benchmark_search_result_vwaymo.csv",
    LLMModels[
        2
    ]: "/opt/Neuro-Symbolic-Video-Frame-Search/store/nsvs_artifact/experiment_2.1_nsvs_ltl/mrcnn/mrcnngpt-4-0613_benchmark_search_result_vwaymo.csv",
}
result_dict_waymo = {}
...
data_loc_ns = {
    LLMModels[
        0
    ]: "/opt/Neuro-Symbolic-Video-Frame-Search/store/nsvs_artifact/experiment_2.1_nsvs_ltl/mrcnn/mrcnngpt-3.5-turbo-instruct_benchmark_search_result_vnuscene.csv",
    LLMModels[
        3
    ...
    LLMModels[
        1
    ]: "/opt/Neuro-Symbolic-Video-Frame-Search/store/nsvs_artifact/experiment_2.1_nsvs_ltl/mrcnn/mrcnngpt-3.5-turbo-0613_benchmark_search_result_vnuscene.csv",
    LLMModels[
        2
    ]: "/opt/Neuro-Symbolic-Video-Frame-Search/store/nsvs_artifact/experiment_2.1_nsvs_ltl/mrcnn/mrcnngpt-4-0613_benchmark_search_result_vnuscene.csv",
}
result_dict_ns = {}
