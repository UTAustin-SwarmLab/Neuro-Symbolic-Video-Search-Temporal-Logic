...
mapping_threshold = (0.70, 0.80)  # (0.10, 0.58)
mapping_param_x0 = 0.40  # 0.10
mapping_param_k = 15
save_csv_file_name = get_file_or_dir_with_datetime(base_name="dino_benchmark_search_result", ext=".csv")
###############
