...
if __name__ == "__main__":
    config = load_config()
    ltl_video_dir = "/opt/Neuro-Symbolic-Video-Frame-Search/store/nsvs_artifact/waymo_banchmark_with_ltl_label"
    save_dir = "/opt/Neuro-Symbolic-Video-Frame-Search/store/nsvs_artifact/waymo_benchmark_frame_video_generated_results"
    # /opt/Neuro-Symbolic-Video-Frame-Search/store/nsvs_artifact/nuscene_video
    # /opt/Neuro-Symbolic-Video-Frame-Search/store/nsvs_artifact/test
    # "/opt/Neuro-Symbolic-Video-Frame-Search/store/nsvs_artifact/waymo_banchmark_with_ltl_label"
