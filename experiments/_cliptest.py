...
for threshold in threshold_list:
    ...
    for file_name in glob.glob('/opt/Neuro-Symbolic-Video-Frame-Search/store/nsvs_artifact/_validated_benchmark_video/imagenet/Fprop1/*.pkl'):
        ...
        gt =[True if x == data.proposition[0] else False for x in data.labels_of_frames]
...
with open('/opt/Neuro-Symbolic-Video-Frame-Search/experiments/res_clipFprop1_v2.pkl', 'wb') as file:
