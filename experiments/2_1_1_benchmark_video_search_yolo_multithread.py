    ...
    for image_set in benchmark_image_set_dir:
        ...
        for ltl_spec in ltl_video_dir_set:
            ...
            for benchmark_video_file in benchmark_video_file_list:
                ...
                # result[ltl_formula] = {}
                cv_detection_model = Yolo(config=config.YOLO, weight_path=weight_path / weight)
...
if __name__ == "__main__":
    ...
    context_pooler = Pool(processes=3)
    context_pooler.map(run_search, weights)
